  ...
  return (
    <RoleGuard allowed={[ROLES.MANUFACTURER]}>
      <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <h2 className="text-2xl font-bold mb-2 text-gray-800 dark:text-white">Orders</h2>
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          Manage and track incoming product orders.
        </p>
              ...
              {mockOrders.map((order) => (
                <tr key={order.orderId}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900 dark:text-white">{order.orderId}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900 dark:text-white">{order.client}</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                      ${order.status === "Pending" ? "bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-200"
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                    <div className="flex items-center space-x-2">
                      ...
                      <button className={`py-1 px-3 rounded-full text-xs font-semibold ${order.urgent ? 'bg-red-500 text-white' : 'bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white'}`}>
                        {order.urgent ? 'Urgent' : 'Process'}
                      </button>
                    </div>
                  </td>
                </tr>
