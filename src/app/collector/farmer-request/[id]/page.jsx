...
const FarmerRequestDetailsPage = () => {
  ...
  const dummyData = {
    ...
    cultivatedDate: "2024-03-15",
    harvestedDate: "2024-08-20",
    ...
    images: {
      ...
      processed:
        "https://images.unsplash.com/photo-1615485290421-62ccbdfe9c73?w=800&h=500&fit=crop",
      quality:
        "https://images.unsplash.com/photo-1586810430304-3ac8dfc909c3?w=800&h=500&fit=crop",
      storage:
        "https://static.theprint.in/wp-content/uploads/2023/09/farmer-Parwar-696x392.jpg?compress=true&quality=80&w=376&dpr=2.6",
    },
    ...
    logistics: {
      preferredPickupDate: "2024-08-28",
